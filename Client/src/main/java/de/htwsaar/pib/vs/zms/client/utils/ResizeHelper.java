...
/**
 * 
 * Diese Klasse stammt aus dem Stackoverflow:
 * https://stackoverflow.com/questions/19455059/allow-user-to-resize-an-undecorated-stage
 * 
 * Die Eigenschaft, die Deckkraft der Buehne beim Verschieben zu ändern, wurde
 * von Feras Ejneid erweitert.
 *
 */
public class ResizeHelper {
	...
	static class ResizeListener implements EventHandler<MouseEvent> {
		...
		public void handle(MouseEvent mouseEvent) {
			...
			if (MouseEvent.MOUSE_DRAGGED.equals(mouseEventType) && Cursor.DEFAULT.equals(cursorEvent)
					&& resizing == false) {
...
//
//			if (MouseEvent.MOUSE_RELEASED.equals(mouseEventType) && Cursor.DEFAULT.equals(cursorEvent)
//					&& resizing == false) {
